...
### Project Links
```
Weights & Biases project link: https://wandb.ai/sabarimooc/nyc_airbnb?workspace=user-sabarimooc
Github repository link: https://github.com/sManohar201/ml-pipeline-for-short-term-rental-prices
```
